...
import { fetchGoodShortDetail, cleanSynopsis } from '@/lib/api';

interface GoodShortDetailPageProps {
  params: Promise<{ id: string }>;
}

export default async function GoodShortDetailPage({ params }: GoodShortDetailPageProps) {
