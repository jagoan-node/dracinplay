...
export default function DramaWaveWatchPage() {
  ...
  useEffect(() => {
    async function loadStream() {
      ...
      setError('');
      try {
        const res = await fetch(`https://api.sonzaix.indevs.in/dramawave/stream?id=${id}&episode=${episode}`);
  ...
  return (
    <div className="min-h-screen py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <h1 className="text-xl md:text-2xl font-bold text-white mb-1">DramaWave Short Drama</h1>
