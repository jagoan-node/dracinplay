...
import { fetchDramaWaveDetail, cleanSynopsis } from '@/lib/api';

interface DramaWaveDetailPageProps {
  params: Promise<{ id: string }>;
}

export default async function DramaWaveDetailPage({ params }: DramaWaveDetailPageProps) {
